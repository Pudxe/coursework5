...
EQUIPMENT_FILE = os.path.join('../coursework5/data', 'equipment.json')
CLASSES_FILE = os.path.join('../coursework5/data', 'hero_classes.json')
SKILLS_FILE = os.path.join('../coursework5/data', 'skills.json')
LOGS_FILE = os.path.join('../coursework5/data', 'unit_phrases.json')
